// src/controllers/maintenance.controller.ts — Capa HTTP
...
export async function getAll(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const result = await service.listMaintenance(page, limit);
...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.getMaintenance(parsed.data);
    res.json({ data: record } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.createMaintenance(result.data);
    res.status(201).json({ data: record } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.updateMaintenance(parsedId.data, result.data);
    res.json({ data: record } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
...
export async function remove(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    await service.deleteMaintenance(parsed.data);
    res.status(204).send();
  } catch (err) {
    next(err);
  }
