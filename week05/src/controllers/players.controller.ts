// src/controllers/players.controller.ts — Capa HTTP
...
export async function getAll(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const result = await service.listPlayers(page, limit);
...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const player = await service.getPlayer(parsed.data);
    res.json({ data: player } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const player = await service.createPlayer(result.data);
    res.status(201).json({ data: player } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const player = await service.updatePlayer(parsedId.data, result.data);
    res.json({ data: player } satisfies SingleResponse<unknown>);
  } catch (err) {
    next(err);
  }
...
export async function remove(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    await service.deletePlayer(parsed.data);
    res.status(204).send();
  } catch (err) {
    next(err);
  }
