// ============================================
// MIDDLEWARES — errorHandler (4 parámetros, SIEMPRE el último)
// ============================================
...
export function errorHandler(
  ...
  // 2. AppError → statusCode (errores operacionales del dominio)
  if (isAppError(err)) {
  ...
  // 3. Error genérico → 500 (stack trace solo en desarrollo)
