...
import { Maintenance, PaginatedResponse, SingleResponse, ValidationErrorResponse } from '../types';
...
export async function getAll(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.json(result satisfies PaginatedResponse<Maintenance>);
  } catch (err) {
    next(err);
  }
}
...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.findById(parsed.data);
    res.json({ data: record } satisfies SingleResponse<Maintenance>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.create(result.data);
    res.status(201).json({ data: record } satisfies SingleResponse<Maintenance>);
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const record = await service.update(parsedId.data, result.data);
    res.json({ data: record } satisfies SingleResponse<Maintenance>);
  } catch (err) {
    next(err);
  }
